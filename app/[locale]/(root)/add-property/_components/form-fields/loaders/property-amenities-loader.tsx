...
export default function PropertyAmenitiesLoader(
  loadingProps: DynamicOptionsLoadingProps
): React.ReactNode {
  return <PropertyAmenitiesLoaderElements loadingProps={loadingProps} />;
}

function PropertyAmenitiesLoaderElements({
  loadingProps,
}: {
  loadingProps?: DynamicOptionsLoadingProps;
}) {
