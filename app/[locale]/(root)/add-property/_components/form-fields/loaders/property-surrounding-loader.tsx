...
export default function PropertySurroundingLoader(
  loadingProps: DynamicOptionsLoadingProps
): React.ReactNode {
  return <PropertySurroundingLoaderElements loadingProps={loadingProps} />;
}

function PropertySurroundingLoaderElements({
  loadingProps,
}: {
  loadingProps?: DynamicOptionsLoadingProps;
}) {
