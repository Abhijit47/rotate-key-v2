...
export default function PropertyEnvironmentLoader(
  loadingProps: DynamicOptionsLoadingProps
): React.ReactNode {
  return <PropertyEnvironmentLoaderElements loadingProps={loadingProps} />;
}

function PropertyEnvironmentLoaderElements({
  loadingProps,
}: {
  loadingProps?: DynamicOptionsLoadingProps;
}) {
